...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/Asset/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/Asset/eye_hide.png")).getImage();
    ...
    private void createShowHide(Graphics2D g2) {
        ...
        g2.drawImage(hide ? eye_hide : eye, x, y,16,16,  null);
    }
